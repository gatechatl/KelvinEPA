...
public class CalculateHeatMapMergeCSV {
	...
	public static void main(String[] args) {
		...
		try {
			...
			String outputFileDomain = "C:\\School Notes\\Kelvin_Metagenomics\\Result\\HeatMapDomain" + shelter + ".csv";
			if (outputCount) {
				outputFileDomain = "C:\\School Notes\\Kelvin_Metagenomics\\Result\\HeatMapDomain" + shelter + "_Count.csv";
			}
			FileWriter fwriterDomain = new FileWriter(outputFileDomain);
			BufferedWriter outDomain = new BufferedWriter(fwriterDomain);
			
			String outputFilePhylum = "C:\\School Notes\\Kelvin_Metagenomics\\Result\\HeatMapPhylum" + shelter + ".csv";
			if (outputCount) {
				outputFilePhylum = "C:\\School Notes\\Kelvin_Metagenomics\\Result\\HeatMapPhylum" + shelter + "_Count.csv";
			}
			FileWriter fwriterPhylum = new FileWriter(outputFilePhylum);
			BufferedWriter outPhylum = new BufferedWriter(fwriterPhylum);			
			
			String outputFileClass = "C:\\School Notes\\Kelvin_Metagenomics\\Result\\HeatMapClass" + shelter + ".csv";
			if (outputCount) {
				outputFileClass = "C:\\School Notes\\Kelvin_Metagenomics\\Result\\HeatMapClass" + shelter + "_Count.csv";
			}
			FileWriter fwriterClass = new FileWriter(outputFileClass);
			BufferedWriter outClass = new BufferedWriter(fwriterClass);			

			String outputFileOrder = "C:\\School Notes\\Kelvin_Metagenomics\\Result\\HeatMapOrder" + shelter + ".csv";
			if (outputCount) {
				outputFileOrder = "C:\\School Notes\\Kelvin_Metagenomics\\Result\\HeatMapOrder" + shelter + "_Count.csv";
			}
			FileWriter fwriterOrder = new FileWriter(outputFileOrder);
			BufferedWriter outOrder = new BufferedWriter(fwriterOrder);			

			String outputFileFamily = "C:\\School Notes\\Kelvin_Metagenomics\\Result\\HeatMapFamily" + shelter + ".csv";
			if (outputCount) {
				outputFileFamily = "C:\\School Notes\\Kelvin_Metagenomics\\Result\\HeatMapFamily" + shelter + "_Count.csv";
			}
			FileWriter fwriterFamily = new FileWriter(outputFileFamily);
			BufferedWriter outFamily = new BufferedWriter(fwriterFamily);			

			String outputFileGenus = "C:\\School Notes\\Kelvin_Metagenomics\\Result\\HeatMapGenus" + shelter + ".csv";
			if (outputCount) {
				outputFileGenus = "C:\\School Notes\\Kelvin_Metagenomics\\Result\\HeatMapGenus" + shelter + "_Count.csv";
			}
